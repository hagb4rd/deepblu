...
var leftFill = function leftFill(string, char, minlength)  {char=char||'0'; /* default: zerofill */ string = string.toString(); while (string.length < min) string = char + string; return string; }
